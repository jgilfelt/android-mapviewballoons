...
public class MapControllerGoogle implements IMapController {

private final com.google.android.maps.MapController mController;
	
	public MapControllerGoogle(final com.google.android.maps.MapController pMapController) {
		mController = pMapController;
	}
	
	@Override
	public void animateTo(IGeoPoint arg0) {
		mController.animateTo(new com.google.android.maps.GeoPoint(arg0.getLatitudeE6(), arg0.getLongitudeE6()));
	}

	@Override
	public void animateTo(IGeoPoint arg0, Message arg1) {
		mController.animateTo(new com.google.android.maps.GeoPoint(arg0.getLatitudeE6(), arg0.getLongitudeE6()), arg1);
	}
	...
	public void setCenter(IGeoPoint arg0) {
		mController.setCenter(new com.google.android.maps.GeoPoint(arg0.getLatitudeE6(), arg0.getLongitudeE6()));
	}
